...
# transforming the drift to interpretable units (category percentage change)
...
# I don't like the Epi function for plotting APC estimates (personal opinion!)
...
# let's compare factor and smoothed (splines) approaches
a/b
